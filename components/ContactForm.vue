<template>
    <section
      class="relative flex flex-col items-center justify-start text-center h-[140vh] px-[var(--margin-xxlarge)]"
    >
      ...
      <div class="flex flex-col items-center justify-center text-[var(--color-background-text)] w-max">
        <h2
          class="2xl:text-6xl xl:text-4xl mt-15 text-(--blue-light) z-50 font-bold p-4"
        >
